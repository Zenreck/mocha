...
## [12.0.0](https://github.com/Zenreck/mocha/compare/v11.1.0...v12.0.0) (2025-03-06)


### ⚠ BREAKING CHANGES

* adapt new engine range for Mocha 11 ([#5216](https://github.com/Zenreck/mocha/issues/5216))
* drop support of 'growl' notification ([#4866](https://github.com/Zenreck/mocha/issues/4866))
* **deps:** upgrade 'minimatch' ([#4865](https://github.com/Zenreck/mocha/issues/4865))
* rename 'bin/mocha' to 'bin/mocha.js' ([#4863](https://github.com/Zenreck/mocha/issues/4863))
* remove deprecated Runner signature ([#4861](https://github.com/Zenreck/mocha/issues/4861))
* drop support of IE11 ([#4848](https://github.com/Zenreck/mocha/issues/4848))
* drop support of Node v12 ([#4845](https://github.com/Zenreck/mocha/issues/4845))

### 🌟 Features

* add file path to xunit reporter ([#4985](https://github.com/Zenreck/mocha/issues/4985)) ([efbb147](https://github.com/Zenreck/mocha/commit/efbb147590dfd7ff290de40a9930b07334784054))
* add MOCHA_OPTIONS env variable ([#4835](https://github.com/Zenreck/mocha/issues/4835)) ([5b7af5e](https://github.com/Zenreck/mocha/commit/5b7af5eec2098f094fe1601b0c5b85499fa67828))
* add new option 'fail-zero' ([#4716](https://github.com/Zenreck/mocha/issues/4716)) ([bbf0c11](https://github.com/Zenreck/mocha/commit/bbf0c11b29544de91a18c1bd667c975ee44b7c90))
* add option to not fail on failing test suite ([#4771](https://github.com/Zenreck/mocha/issues/4771)) ([deb8679](https://github.com/Zenreck/mocha/commit/deb8679810a60aa5198f49751f3d7b71e10fe072))
* allow ^ versions for character encoding packages ([#5150](https://github.com/Zenreck/mocha/issues/5150)) ([38695da](https://github.com/Zenreck/mocha/commit/38695dadba21a488d7c54424a75d537f52cd250a))
* allow ^ versions for data serialization packages ([#5153](https://github.com/Zenreck/mocha/issues/5153)) ([514b83f](https://github.com/Zenreck/mocha/commit/514b83ff9b7048130faaff3479882fa0819830e2))
* allow ^ versions for file matching packages ([#5151](https://github.com/Zenreck/mocha/issues/5151)) ([be82606](https://github.com/Zenreck/mocha/commit/be826062f21ac38e310d981490110c38abacc3f6))
* allow ^ versions for miscellaneous packages ([#5154](https://github.com/Zenreck/mocha/issues/5154)) ([bb8d7b9](https://github.com/Zenreck/mocha/commit/bb8d7b954495b33f93010ee43f39b9ab5ec37308))
* allow ^ versions for yargs packages ([#5152](https://github.com/Zenreck/mocha/issues/5152)) ([71e9fba](https://github.com/Zenreck/mocha/commit/71e9fbae3bd7b706c142cce5b249e65a7c2ce6d4))
* allow calling hook methods ([#5231](https://github.com/Zenreck/mocha/issues/5231)) ([e3da641](https://github.com/Zenreck/mocha/commit/e3da641b08bed20f12df524fc64cb9579f980c1e))
* bump yargs to 17 ([#5165](https://github.com/Zenreck/mocha/issues/5165)) ([8f1c8d8](https://github.com/Zenreck/mocha/commit/8f1c8d888b0104afcd95ca55a517320399755749))
* bumped glob dependency from 8 to 10 ([#5250](https://github.com/Zenreck/mocha/issues/5250)) ([43c3157](https://github.com/Zenreck/mocha/commit/43c3157c6ef4f2d4bfecf3ad3a42479fd64187b8))
* **esm:** ability to decorate ESM module name before importing it ([#4945](https://github.com/Zenreck/mocha/issues/4945)) ([73bb819](https://github.com/Zenreck/mocha/commit/73bb81904fa017fc474973ce9b1e8fc325709142))
* highlight browser failures ([#5222](https://github.com/Zenreck/mocha/issues/5222)) ([8ff4845](https://github.com/Zenreck/mocha/commit/8ff48453a8b12d9cacf56b0c0c544c8256af64c7))
* include `.cause` stacks in the error stack traces ([#4829](https://github.com/Zenreck/mocha/issues/4829)) ([3735873](https://github.com/Zenreck/mocha/commit/37358738260cfae7c244c157aee21654f2b588f2))
* **parallel:** assign each worker a worker-id ([#4813](https://github.com/Zenreck/mocha/issues/4813)) ([8b089a2](https://github.com/Zenreck/mocha/commit/8b089a2997a7d7b35a6fc66cbc5483afccae9c93))
* replace `strip-ansi` with `util.stripVTControlCharacters` ([#5267](https://github.com/Zenreck/mocha/issues/5267)) ([3c191c0](https://github.com/Zenreck/mocha/commit/3c191c05d9db1e99aec9b600edac2ce10a6b6d71)), closes [#5265](https://github.com/Zenreck/mocha/issues/5265)
* **reporter:** add output option to 'JSON' ([#4607](https://github.com/Zenreck/mocha/issues/4607)) ([171e211](https://github.com/Zenreck/mocha/commit/171e211cd2938b3f87011fa8c717292cb08adbe7))
* use &lt;progress&gt; and &lt;svg&gt; for browser progress indicator instead of &lt;canvas&gt; ([#5015](https://github.com/Zenreck/mocha/issues/5015)) ([e263c7a](https://github.com/Zenreck/mocha/commit/e263c7a722b8c2fcbe83596836653896a9e0258b))


### 🩹 Fixes

* adapt new engine range for Mocha 11 ([#5216](https://github.com/Zenreck/mocha/issues/5216)) ([80da25a](https://github.com/Zenreck/mocha/commit/80da25a4132ca50d3ad35087cb62c9b0f8fc946a))
* add alt text to Built with Netlify badge ([#5068](https://github.com/Zenreck/mocha/issues/5068)) ([8812413](https://github.com/Zenreck/mocha/commit/8812413288c42ef80528f10181040ab75ed3375c))
* Add error handling for nonexistent file case with --file option ([#5086](https://github.com/Zenreck/mocha/issues/5086)) ([dbe229d](https://github.com/Zenreck/mocha/commit/dbe229d1b7ce672a02992b12ecb38a1cdd440a1e))
* add Mocha to global variable ([2b8a1ff](https://github.com/Zenreck/mocha/commit/2b8a1ff636d58b023ae727dcef8e0c5d7784496e))
* better tracking of seen objects in error serialization ([#5032](https://github.com/Zenreck/mocha/issues/5032)) ([02c04c4](https://github.com/Zenreck/mocha/commit/02c04c48d751554532ceeeb59786b457847cd4f3))
* **browser:** enable 'bdd' import for bundlers ([#4769](https://github.com/Zenreck/mocha/issues/4769)) ([012d79d](https://github.com/Zenreck/mocha/commit/012d79de00698eebca8366f03466cbfbf8afaf7b))
* **browser:** failed test icon color ([#4946](https://github.com/Zenreck/mocha/issues/4946)) ([b0a0fb8](https://github.com/Zenreck/mocha/commit/b0a0fb808c6d771f198fca120527222f92edaa57))
* **browser:** increase contrast for replay buttons ([#4912](https://github.com/Zenreck/mocha/issues/4912)) ([4e06a6f](https://github.com/Zenreck/mocha/commit/4e06a6fd00537bcdb1b6fd98b4684875356193f9))
* **browser:** stop using all global vars in 'browser-entry' ([#4746](https://github.com/Zenreck/mocha/issues/4746)) ([8421974](https://github.com/Zenreck/mocha/commit/8421974e8d252e2ef11602d15bed178e4f5f4534))
* catch exceptions setting Error.stackTraceLimit ([#5254](https://github.com/Zenreck/mocha/issues/5254)) ([259f8f8](https://github.com/Zenreck/mocha/commit/259f8f8ba5709b5d84fa66e17cd10560a11f45c9))
* check if module.paths really exists ([#4194](https://github.com/Zenreck/mocha/issues/4194)); closes [#2505](https://github.com/Zenreck/mocha/issues/2505) ([8b6a76c](https://github.com/Zenreck/mocha/commit/8b6a76c8dc64e8a16f3c995f22a53fbc86b3f173))
* closes [#5115](https://github.com/Zenreck/mocha/issues/5115) ([#5116](https://github.com/Zenreck/mocha/issues/5116)) ([a2e600d](https://github.com/Zenreck/mocha/commit/a2e600d70f4d7ca6ba8741ebe8c70cfec438ef1b))
* configurable max diff size ([#4799](https://github.com/Zenreck/mocha/issues/4799)) ([11c4560](https://github.com/Zenreck/mocha/commit/11c45609b56dda11460b1f8e0d2a415cf8f9915d))
* control stringification of error message ([#4128](https://github.com/Zenreck/mocha/issues/4128)) ([1c4e623](https://github.com/Zenreck/mocha/commit/1c4e623c020c97269922dc9e23a951f63ad8f7b8))
* crash with --parallel and --retries both enabled ([#5173](https://github.com/Zenreck/mocha/issues/5173)) ([d7013dd](https://github.com/Zenreck/mocha/commit/d7013ddb1099cfafe66a1af9640370998290e62c))
* do not exit when only unref'd timer is present in test code ([#3825](https://github.com/Zenreck/mocha/issues/3825)) ([6d24689](https://github.com/Zenreck/mocha/commit/6d24689b2905dd4615f317d80e8388979263bab5))
* **dry-run:** potential call-stack crash with 'dry-run' option ([#4839](https://github.com/Zenreck/mocha/issues/4839)) ([22f9306](https://github.com/Zenreck/mocha/commit/22f9306265287eee3d273e174873fa16046376b6))
* error handling for unexpected numeric arguments passed to cli ([#5263](https://github.com/Zenreck/mocha/issues/5263)) ([210d658](https://github.com/Zenreck/mocha/commit/210d658678a2ec3b6f85c59d4b300b4722671099))
* **esm:** allow `import` from mocha in parallel ([#4574](https://github.com/Zenreck/mocha/issues/4574)) ([8d6d1e3](https://github.com/Zenreck/mocha/commit/8d6d1e359e50badc27c48e5b1aa0c577907663e9))
* handle case of invalid package.json with no explicit config ([#5198](https://github.com/Zenreck/mocha/issues/5198)) ([f72bc17](https://github.com/Zenreck/mocha/commit/f72bc17cb44164bcfff7abc83d0d37d99a061104))
* harden error handling in `lib/cli/run.js` ([#5074](https://github.com/Zenreck/mocha/issues/5074)) ([97dcbb2](https://github.com/Zenreck/mocha/commit/97dcbb28225105f16e90d2180aa2be3386d7ec1a))
* include stack in browser uncaught error reporting ([#5107](https://github.com/Zenreck/mocha/issues/5107)) ([67a8124](https://github.com/Zenreck/mocha/commit/67a81245f969267dbb1878c73d593d8316d5706f))
* **integration:** revert deprecation of 'EVENT_SUITE_ADD_*' events ([#4764](https://github.com/Zenreck/mocha/issues/4764)) ([111467f](https://github.com/Zenreck/mocha/commit/111467fa6fbcea153074d57442f15055c4cd592a))
* karma-mocha should run both browser bundles ([#4663](https://github.com/Zenreck/mocha/issues/4663)) ([f033ff1](https://github.com/Zenreck/mocha/commit/f033ff1ab561101e956285924343c23150cd6595))
* make it().timeout() work again ([#4599](https://github.com/Zenreck/mocha/issues/4599)) ([6a47776](https://github.com/Zenreck/mocha/commit/6a47776178826323efd0d3278f8cddd3746544ed))
* make release-please build work ([#5194](https://github.com/Zenreck/mocha/issues/5194)) ([afd66ef](https://github.com/Zenreck/mocha/commit/afd66ef3df20fab51ce38b97216c09108e5c2bfd))
* **parallel:** 'XUNIT' and 'JSON' reporter crash ([#4623](https://github.com/Zenreck/mocha/issues/4623)) ([9e0369b](https://github.com/Zenreck/mocha/commit/9e0369b03475d0cc4ffbd32523bdf95b287fe9b7))
* programmatic API cannot access retried test objects ([#4181](https://github.com/Zenreck/mocha/issues/4181)) ([a995e33](https://github.com/Zenreck/mocha/commit/a995e3324b9da02c9cda8ad26e2695a853c28f30))
* regex in 'update-authors.js' ([011a5a4](https://github.com/Zenreck/mocha/commit/011a5a43ba454fb1c3247ac51e69e855ed6ac512))
* remove `:is()` from `mocha.css` to support older browsers ([#5225](https://github.com/Zenreck/mocha/issues/5225)) ([#5227](https://github.com/Zenreck/mocha/issues/5227)) ([0a24b58](https://github.com/Zenreck/mocha/commit/0a24b58477ea8ad146afc798930800b02c08790a))
* remove job count from parallel mode debug log ([#4416](https://github.com/Zenreck/mocha/issues/4416)) ([31116db](https://github.com/Zenreck/mocha/commit/31116dbf825487490d5416c95b2685e18e7359d3))
* runner listening to 'start' and 'end' events ([#3660](https://github.com/Zenreck/mocha/issues/3660)) ([e1389ef](https://github.com/Zenreck/mocha/commit/e1389efd949f57e0ee32c7b52df09d5040464084))
* support canonical module ([#5040](https://github.com/Zenreck/mocha/issues/5040)) ([579e047](https://github.com/Zenreck/mocha/commit/579e047802d1b4e22ddf4162622d5e1322c2caac))
* support errors with circular dependencies in object values with --parallel ([#5212](https://github.com/Zenreck/mocha/issues/5212)) ([ba0fefe](https://github.com/Zenreck/mocha/commit/ba0fefe10b08a689cf49edc3818026938aa3a240))
* test link in html reporter ([#5224](https://github.com/Zenreck/mocha/issues/5224)) ([f054acc](https://github.com/Zenreck/mocha/commit/f054acc1f60714bbe00ad1ab270fb4977836d045))
* Typos on mochajs.org ([#5237](https://github.com/Zenreck/mocha/issues/5237)) ([d8ca270](https://github.com/Zenreck/mocha/commit/d8ca270a960554c9d5c5fbf264e89d668d01ff0d))
* use accurate test links in HTML reporter ([#5228](https://github.com/Zenreck/mocha/issues/5228)) ([68803b6](https://github.com/Zenreck/mocha/commit/68803b685d55dcccc51fa6ccfd27701cda4e26ed))
* using custom interface in parallel mode ([#4688](https://github.com/Zenreck/mocha/issues/4688)) ([3722201](https://github.com/Zenreck/mocha/commit/37222019348d604f741cdecc3fe58d9bb7188ba9))
* **vulnerabilty:** update to serialize-javascript@3.1 ([f073689](https://github.com/Zenreck/mocha/commit/f0736891eb6c903f141c6df779c6481a5edf337e))
* **website:** improve backers sprite image ([#4756](https://github.com/Zenreck/mocha/issues/4756)) ([0ea732c](https://github.com/Zenreck/mocha/commit/0ea732c1169c678ef116c3eb452cc94758fff150))
* wrong error thrown if loader is used ([#4807](https://github.com/Zenreck/mocha/issues/4807)) ([baa12fd](https://github.com/Zenreck/mocha/commit/baa12fd73e59ab6139d05d5eb76222c5d7a774ba))
* wrong error thrown while loading config files ([#4832](https://github.com/Zenreck/mocha/issues/4832)) ([86305cf](https://github.com/Zenreck/mocha/commit/86305cfed39de6fdfe0cead10759b19dce037370))
* wrong error thrown while loading reporter ([#4842](https://github.com/Zenreck/mocha/issues/4842)) ([241964b](https://github.com/Zenreck/mocha/commit/241964b71c7839263a33a18f0f36a0c6c43f73e2))
* xunit integration test ([#5122](https://github.com/Zenreck/mocha/issues/5122)) ([6f3f45e](https://github.com/Zenreck/mocha/commit/6f3f45e587a17463b75047631152429fa14b82a3))


### 📚 Documentation

* add "options.require" to Mocha constructor ([#4630](https://github.com/Zenreck/mocha/issues/4630)) [ci skip] ([d35eb9d](https://github.com/Zenreck/mocha/commit/d35eb9debd437a0a88281e11fb390934848940b3))
* add `SECURITY.md` pointing to Tidelift ([#5210](https://github.com/Zenreck/mocha/issues/5210)) ([bd7e63a](https://github.com/Zenreck/mocha/commit/bd7e63a1f6d98535ce1ed1ecdb57b3e4db8a33c5))
* add 10.3.0 to CHANGELOG.md ([728cfe8](https://github.com/Zenreck/mocha/commit/728cfe8120a992f2f79a0f7e92a3e3a1c3aede0f))
* add 10.5.0 to CHANGELOG.md ([12c88a7](https://github.com/Zenreck/mocha/commit/12c88a75694f7e923114f6943a0dbd66302945c3))
* add 10.5.1 to CHANGELOG.md ([545b66d](https://github.com/Zenreck/mocha/commit/545b66d5927472378aed8e19317212a7535c1650))
* add 10.5.2 to CHANGELOG.md ([a3bb86d](https://github.com/Zenreck/mocha/commit/a3bb86d52b96ab9776bb6897337435443ef846cc))
* add 10.6.0 to CHANGELOG.md ([021aa80](https://github.com/Zenreck/mocha/commit/021aa80442436b448c4b1da81449676928610be7))
* add 10.6.1 to CHANGELOG.md ([3855e66](https://github.com/Zenreck/mocha/commit/3855e6688b42f4112c1227133fd4a308b8f66271))
* add 10.7.0 to CHANGELOG.md and docs/index.md ([8711e72](https://github.com/Zenreck/mocha/commit/8711e72b9dd573dff6940061dd5643986c02f38a))
* add complete '--delay' example ([#4744](https://github.com/Zenreck/mocha/issues/4744)) [ci skip] ([27bfc74](https://github.com/Zenreck/mocha/commit/27bfc7425fed7a9a9cadb6dabc536a0bd32abd7a))
* add example of generating tests with a closure ([#4494](https://github.com/Zenreck/mocha/issues/4494)) ([9f2dd41](https://github.com/Zenreck/mocha/commit/9f2dd41292615ae7798ac47d37202e37f02a266e))
* add instructions for API docs ([#5287](https://github.com/Zenreck/mocha/issues/5287)) ([b720ec1](https://github.com/Zenreck/mocha/commit/b720ec1b3ca630a90f80311da391b2a0cdfead4e))
* add sponsored to sponsorship link rels ([#5097](https://github.com/Zenreck/mocha/issues/5097)) ([6531df8](https://github.com/Zenreck/mocha/commit/6531df8f19a7459903bab87fb965b3be56624c77))
* Add warning about async callback for describe ([#5046](https://github.com/Zenreck/mocha/issues/5046)) ([c43930c](https://github.com/Zenreck/mocha/commit/c43930cc6dc41980f4fcf054d506d780a28a72df))
* adopt Collective Funds Guidelines 0.1 ([#5199](https://github.com/Zenreck/mocha/issues/5199)) ([2b03d86](https://github.com/Zenreck/mocha/commit/2b03d865eec63d627ff229e07d777f25061260d4))
* clarify invalid usage of done() ([#4101](https://github.com/Zenreck/mocha/issues/4101)) ([ebdee97](https://github.com/Zenreck/mocha/commit/ebdee973a1c8f048bdb9d62dbfec8b55791fea95))
* correct outdated `status: accepting prs` link ([#5268](https://github.com/Zenreck/mocha/issues/5268)) ([f729cd0](https://github.com/Zenreck/mocha/commit/f729cd09b61bb598409f19b3c76b9e9536812237))
* document Node.js --enable-source-maps flag ([80863b1](https://github.com/Zenreck/mocha/commit/80863b14709450f8d4eb7e22722d2de79ad62688))
* downgrade example/tests chai to 4.5.0 ([#5245](https://github.com/Zenreck/mocha/issues/5245)) ([eac87e1](https://github.com/Zenreck/mocha/commit/eac87e10f49207a9b388f87d77d198583c6f889a))
* dynamic tests with top-level await ([#4617](https://github.com/Zenreck/mocha/issues/4617)) [ci skip] ([8a2da76](https://github.com/Zenreck/mocha/commit/8a2da76001142005826e544e4fb702ae2a77797f))
* fix 'fgrep' url ([#4873](https://github.com/Zenreck/mocha/issues/4873)) ([b863359](https://github.com/Zenreck/mocha/commit/b863359cc80e3db06b180bff9e3c21afd0b2acd7))
* fix broken table width under 450 screen width ([#4734](https://github.com/Zenreck/mocha/issues/4734)) ([abfddf8](https://github.com/Zenreck/mocha/commit/abfddf8762a9b01efea2ba8737ab858669d7ca51))
* fix CHANGELOG.md headings to start with a root-level h1 ([#5083](https://github.com/Zenreck/mocha/issues/5083)) ([7f6f040](https://github.com/Zenreck/mocha/commit/7f6f040a9b6f54365f07b84e7ea27a6904d4f556))
* fix documentation concerning glob expansion on UNIX ([#4869](https://github.com/Zenreck/mocha/issues/4869)) ([a5b5652](https://github.com/Zenreck/mocha/commit/a5b565289b40a839af086b13fb369e04e205ed4b))
* fix examples for `linkPartialObjects` methods ([#5255](https://github.com/Zenreck/mocha/issues/5255)) ([34e0e52](https://github.com/Zenreck/mocha/commit/34e0e52e047a9119aeae9cb5b660a8438656a1e0))
* fix fragment ID for yargs.js `extends` docs ([#4918](https://github.com/Zenreck/mocha/issues/4918)) ([4b60c1a](https://github.com/Zenreck/mocha/commit/4b60c1ad07a3baaedab86c3787d8baad29538b8f))
* fix javascript syntax errors ([#4555](https://github.com/Zenreck/mocha/issues/4555)) ([c667d10](https://github.com/Zenreck/mocha/commit/c667d1060f97da24abf48e41a284e037f0b410a0))
* fix month numbers in CHANGELOG.md ([528836e](https://github.com/Zenreck/mocha/commit/528836eae9855d30c28bcf9f36577b4f1f34a7c9))
* fix return jsdoc type  of `titlePath` ([#4886](https://github.com/Zenreck/mocha/issues/4886)) ([eca4fec](https://github.com/Zenreck/mocha/commit/eca4fec9eee1332a0474b80aa1740822438955f3))
* how to use 'rootHooks' in the browser ([#4755](https://github.com/Zenreck/mocha/issues/4755)) [ci skip] ([c7f56d1](https://github.com/Zenreck/mocha/commit/c7f56d13f2bf64befef42ad8299d720e2eb42152))
* improve 'grep()' and clarify docs ([#4714](https://github.com/Zenreck/mocha/issues/4714)) ([757b85d](https://github.com/Zenreck/mocha/commit/757b85dd230079901b181c68f0be82b9a3de6407))
* improve filtering ([#5191](https://github.com/Zenreck/mocha/issues/5191)) ([1ac5b55](https://github.com/Zenreck/mocha/commit/1ac5b552e3f32694d349023cb7f6196ba92b180e))
* improve third-party reporter docs ([#5285](https://github.com/Zenreck/mocha/issues/5285)) ([c5a0ef5](https://github.com/Zenreck/mocha/commit/c5a0ef523d52d8cab50e4a9b226af3790f54e75f))
* indicate 'exports' interface does not work in browsers ([#5181](https://github.com/Zenreck/mocha/issues/5181)) ([14e640e](https://github.com/Zenreck/mocha/commit/14e640ee49718d587779a9594b18f3796c42cf2a))
* overhaul contributing and maintenance docs for end-of-year 2023 ([#5038](https://github.com/Zenreck/mocha/issues/5038)) ([9f99178](https://github.com/Zenreck/mocha/commit/9f9917822fa1d3fe2ec2867809cbbf86f4165f0c))
* remove duplicated header ([#4944](https://github.com/Zenreck/mocha/issues/4944)) ([0a10ddc](https://github.com/Zenreck/mocha/commit/0a10ddc1213c208ccc106acc9e8bf372a25f0dc4))
* remove outdated license scan badge ([#5167](https://github.com/Zenreck/mocha/issues/5167)) ([8d0ca3e](https://github.com/Zenreck/mocha/commit/8d0ca3ed77ba8a704b2aa8b58267a084a475a51b))
* remove outdated mailing list reference ([#5169](https://github.com/Zenreck/mocha/issues/5169)) ([f44e483](https://github.com/Zenreck/mocha/commit/f44e483131789b61739896ac96570a35273455f1))
* remove unsupported 'no-timeout' option ([#4719](https://github.com/Zenreck/mocha/issues/4719)) [ci skip] ([f19d3ca](https://github.com/Zenreck/mocha/commit/f19d3ca672e71950788bb577a7f3fb1cbf6c2d1b))
* Replace :coffee: with emoji ([#4092](https://github.com/Zenreck/mocha/issues/4092)) ([dca588d](https://github.com/Zenreck/mocha/commit/dca588da9a78b526454544c7e30891b1a3346e5a))
* replace 'git.io' short links ([#4877](https://github.com/Zenreck/mocha/issues/4877)) [ci skip] ([2b98521](https://github.com/Zenreck/mocha/commit/2b98521756e69d3f0cdb36855b446954ba2bdf74))
* replace "New in" with "Since" in version annotations ([#5262](https://github.com/Zenreck/mocha/issues/5262)) ([6f10d12](https://github.com/Zenreck/mocha/commit/6f10d12c6c6dfa4df7d5221a3ce688f687aaf320))
* show netlify badge on footer ([#4190](https://github.com/Zenreck/mocha/issues/4190)) ([4dc3cd1](https://github.com/Zenreck/mocha/commit/4dc3cd1cd3dbae13f81d4d0e1386dcee67e25194))
* touchups to labels and a template title post-revamp ([#5050](https://github.com/Zenreck/mocha/issues/5050)) ([645469e](https://github.com/Zenreck/mocha/commit/645469e1920e2e86458ff068e74eef2e2915083e))
* update browser options ([b431609](https://github.com/Zenreck/mocha/commit/b431609f01c8d6e7399ab592d6df1a319f81eea7))
* update missed default extensions ([#4608](https://github.com/Zenreck/mocha/issues/4608)) [ci skip] ([dc0ec84](https://github.com/Zenreck/mocha/commit/dc0ec8455f6eaca993b82d322e89f5f3244691ff))
* update README, LICENSE and fix outdated ([#5197](https://github.com/Zenreck/mocha/issues/5197)) ([1203e0e](https://github.com/Zenreck/mocha/commit/1203e0ed739bbbf12166078738357fdb29a8c000))
* use mocha.js instead of mocha in the example run ([#4927](https://github.com/Zenreck/mocha/issues/4927)) ([060f77d](https://github.com/Zenreck/mocha/commit/060f77dc2f97daac996fce926e7527e438c17e85))


### 🧹 Chores

* activate dependabot for workflows ([#5123](https://github.com/Zenreck/mocha/issues/5123)) ([7a2781c](https://github.com/Zenreck/mocha/commit/7a2781c17d4924c620ce5b31c4aab6c88bed72ef))
* add 'status: in triage' label to issue templates and docs ([#5093](https://github.com/Zenreck/mocha/issues/5093)) ([3a4c4b7](https://github.com/Zenreck/mocha/commit/3a4c4b71759b3ca6cd80a31052ea606ff4475ace))
* add knip to validate included dependencies ([5c2989f](https://github.com/Zenreck/mocha/commit/5c2989fcc7ae17618d9db16d7c99e23dfb1d38ee))
* add mtfoley/pr-compliance-action ([#5077](https://github.com/Zenreck/mocha/issues/5077)) ([f9e87d6](https://github.com/Zenreck/mocha/commit/f9e87d64d07959667d46a8eaeac2612822778bb1))
* allow blank issues ([#5157](https://github.com/Zenreck/mocha/issues/5157)) ([2f3fedc](https://github.com/Zenreck/mocha/commit/2f3fedcc41cbb9d3e503d84098fcc07d7c3c49f1))
* allow using any 3.x chokidar dependencies ([#5143](https://github.com/Zenreck/mocha/issues/5143)) ([472a8be](https://github.com/Zenreck/mocha/commit/472a8be14f9b578c8b1ef3e6ae05d06fc2d9891b))
* bump ESLint ecmaVersion to 2020 ([#5104](https://github.com/Zenreck/mocha/issues/5104)) ([b88978d](https://github.com/Zenreck/mocha/commit/b88978deb3c12f9b95502828f6ac29ebe8be85ef))
* **ci:** add Node v17 to test matrix ([#4777](https://github.com/Zenreck/mocha/issues/4777)) ([a99d40c](https://github.com/Zenreck/mocha/commit/a99d40c1f78fec00dd9640c7a8a097b73c3b904f))
* **ci:** add Node v18 to test matrix ([#4876](https://github.com/Zenreck/mocha/issues/4876)) ([007fa65](https://github.com/Zenreck/mocha/commit/007fa65d5f382916b0c264cde395c0051aef7830))
* **ci:** add Node v19 to test matrix ([#4974](https://github.com/Zenreck/mocha/issues/4974)) ([37deed2](https://github.com/Zenreck/mocha/commit/37deed262d4bc0788d32c66636495d10038ad398))
* **ci:** conditionally skip 'push' event ([#4872](https://github.com/Zenreck/mocha/issues/4872)) ([59f6192](https://github.com/Zenreck/mocha/commit/59f619227428e22265b26d3788505d6e081c0e2a))
* **ci:** ignore changes to docs files ([#4871](https://github.com/Zenreck/mocha/issues/4871)) ([baaa41a](https://github.com/Zenreck/mocha/commit/baaa41ae42523977446c4c2c56f716b9d3563d3d))
* **ci:** upgrade GH actions to latest versions ([#4899](https://github.com/Zenreck/mocha/issues/4899)) ([84b2f84](https://github.com/Zenreck/mocha/commit/84b2f846148b180d6e1af088f77358a85c81d1ba))
* **ci:** workaround for firefox error ([#4933](https://github.com/Zenreck/mocha/issues/4933)) ([8f3c37b](https://github.com/Zenreck/mocha/commit/8f3c37b6b77b6754cd9445204c536c1a0671450a))
* **deps:** chokidar@3.4.3 ([3b333ec](https://github.com/Zenreck/mocha/commit/3b333ecf6168943605caa1bcd07b2acf38835057))
* **deps:** remove 'wide-align' ([#4754](https://github.com/Zenreck/mocha/issues/4754)) ([a87461c](https://github.com/Zenreck/mocha/commit/a87461caf23999a8b0a64b5f46486b53900a8461))
* **deps:** update 'glob' to v8 ([#4970](https://github.com/Zenreck/mocha/issues/4970)) ([d722d00](https://github.com/Zenreck/mocha/commit/d722d0038602eeb6968616b49ec79288100fdc72))
* **deps:** upgrade 'minimatch' ([#4865](https://github.com/Zenreck/mocha/issues/4865)) ([3946453](https://github.com/Zenreck/mocha/commit/3946453dedc8bbc7504f162ee95cb2b14997adc8))
* **deps:** upgrade all to latest stable ([#4556](https://github.com/Zenreck/mocha/issues/4556)) ([1a05ad7](https://github.com/Zenreck/mocha/commit/1a05ad706399f3932fbbad3ff0180456c867fb87))
* **deps:** upgrade to latest stable ([2852505](https://github.com/Zenreck/mocha/commit/28525054220a26022f9c049c08d578a18c874d7e))
* **devDeps:** remove 'cross-spawn' ([#4779](https://github.com/Zenreck/mocha/issues/4779)) ([3b4cc05](https://github.com/Zenreck/mocha/commit/3b4cc05f3fa0502d5d714a8f62ac8785267aa695))
* **devDeps:** remove unused depedencies ([#4949](https://github.com/Zenreck/mocha/issues/4949)) ([fc4ac58](https://github.com/Zenreck/mocha/commit/fc4ac58f1fda1a178b26189398b65f66f6561716))
* **devDeps:** update 'eslint' and its plugins ([#4737](https://github.com/Zenreck/mocha/issues/4737)) ([4860738](https://github.com/Zenreck/mocha/commit/4860738af9de9493fade35aea3df65dc7461e100))
* **devDeps:** update 'ESLint' to v8 ([#4926](https://github.com/Zenreck/mocha/issues/4926)) ([51d4746](https://github.com/Zenreck/mocha/commit/51d4746cf6ccefdcfcbc841c92f70efaa338e34f))
* **devDeps:** update 'prettier' ([#4776](https://github.com/Zenreck/mocha/issues/4776)) ([ac43029](https://github.com/Zenreck/mocha/commit/ac43029d6a86150a48ccd59e50e89ca10c72a9c0))
* **devDeps:** upgrade '@11ty/eleventy' to v1.0.0 ([#4844](https://github.com/Zenreck/mocha/issues/4844)) ([b46db73](https://github.com/Zenreck/mocha/commit/b46db73fa0e58c92bde925eaa4054210b771b5a9))
* **devDeps:** upgrade 'coffee-script' ([#4856](https://github.com/Zenreck/mocha/issues/4856)) ([ed640c4](https://github.com/Zenreck/mocha/commit/ed640c49a2984ccf04d0d1d516950996d8248288))
* drop support of 'growl' notification ([#4866](https://github.com/Zenreck/mocha/issues/4866)) ([ac81cc5](https://github.com/Zenreck/mocha/commit/ac81cc53788e11f1dad5dae9c300b16049ed934f))
* drop support of IE11 ([#4848](https://github.com/Zenreck/mocha/issues/4848)) ([70fe3ad](https://github.com/Zenreck/mocha/commit/70fe3adbbbda045c3cf6cc218dfa8dcfc7ab8ca1))
* drop support of Node v12 ([#4845](https://github.com/Zenreck/mocha/issues/4845)) ([d7f6ea5](https://github.com/Zenreck/mocha/commit/d7f6ea5f5d8406204053618c708634dbf5aa9670))
* **esm:** remove code for Node v12 ([#4874](https://github.com/Zenreck/mocha/issues/4874)) ([f6695f0](https://github.com/Zenreck/mocha/commit/f6695f0df57f7ba8fae58341de0abeb7bdfd0d31))
* **esm:** remove code for Node versions &lt;10 ([#4736](https://github.com/Zenreck/mocha/issues/4736)) ([97b8470](https://github.com/Zenreck/mocha/commit/97b84708afb42e552cb906a54f9f2aa2e6a98ba4))
* fix docs builds by re-adding eleventy and ignoring gitignore again ([#5240](https://github.com/Zenreck/mocha/issues/5240)) ([881e3b0](https://github.com/Zenreck/mocha/commit/881e3b0ca2e24284aab2a04f63639a0aa9e0ad1b))
* fix failing markdown linting ([#5193](https://github.com/Zenreck/mocha/issues/5193)) ([7e7a2ec](https://github.com/Zenreck/mocha/commit/7e7a2ecb9bf8daba7e885a880bd8314b7b6fe07d))
* fix header generation and production build crashes  ([#5100](https://github.com/Zenreck/mocha/issues/5100)) ([51502ab](https://github.com/Zenreck/mocha/commit/51502abdd8bfa44114756203e0c5c528ed4a7d8f))
* fix link in pull request template ([#5091](https://github.com/Zenreck/mocha/issues/5091)) ([a886829](https://github.com/Zenreck/mocha/commit/a88682963619e4424c9fdcdbb46f66dc9e68876a))
* fix npm scripts on windows ([#5219](https://github.com/Zenreck/mocha/issues/5219)) ([1173da0](https://github.com/Zenreck/mocha/commit/1173da0bf614e8d2a826687802ee8cbe8671ccf1))
* fix some typos in comments ([#5135](https://github.com/Zenreck/mocha/issues/5135)) ([99601da](https://github.com/Zenreck/mocha/commit/99601da68d59572b6aa931e9416002bcb5b3e19d))
* fix the ci ([#5020](https://github.com/Zenreck/mocha/issues/5020)) ([f8f9fd5](https://github.com/Zenreck/mocha/commit/f8f9fd57740f964df6ee31fd6514a179fce453e4))
* **gha:** update 'stale.yml' ([#4718](https://github.com/Zenreck/mocha/issues/4718)) [ci skip] ([9f82ccb](https://github.com/Zenreck/mocha/commit/9f82ccbd1efa35b8007fcefaa56f563f5145ae42))
* inline nyan reporter's write function ([#5056](https://github.com/Zenreck/mocha/issues/5056)) ([1ebff45](https://github.com/Zenreck/mocha/commit/1ebff45397853e83fb4909c1b0136957d4487528))
* **main:** release 10.7.1 ([#5189](https://github.com/Zenreck/mocha/issues/5189)) ([1528c42](https://github.com/Zenreck/mocha/commit/1528c4257a204533d1ed3c34c049a76a8c29f659))
* **main:** release 10.7.2 ([#5192](https://github.com/Zenreck/mocha/issues/5192)) ([9e0a4bd](https://github.com/Zenreck/mocha/commit/9e0a4bdc3ca7dbc7f7f9776f76efff6fdc3fb0cf))
* **main:** release 10.7.3 ([#5195](https://github.com/Zenreck/mocha/issues/5195)) ([d5766c8](https://github.com/Zenreck/mocha/commit/d5766c887e72b1bb55d5efeac33b1cadd0544b84))
* **main:** release 10.8.0 ([#5200](https://github.com/Zenreck/mocha/issues/5200)) ([6062f92](https://github.com/Zenreck/mocha/commit/6062f9252f095ab5a2659002f6637fe710e815fe))
* **main:** release 10.8.1 ([#5238](https://github.com/Zenreck/mocha/issues/5238)) ([f44f71b](https://github.com/Zenreck/mocha/commit/f44f71bd2897c4f5dcd688d838fec33fdb5818a9))
* **main:** release 10.8.2 ([#5239](https://github.com/Zenreck/mocha/issues/5239)) ([05097db](https://github.com/Zenreck/mocha/commit/05097db4f2e0118f033978b8503aec36b1867c55))
* **main:** release 11.0.0 prerelease ([#5241](https://github.com/Zenreck/mocha/issues/5241)) ([d3b2c38](https://github.com/Zenreck/mocha/commit/d3b2c386db74f0d448c7381097381dedb1c996f2))
* **main:** release 11.0.1 ([#5257](https://github.com/Zenreck/mocha/issues/5257)) ([4c558fb](https://github.com/Zenreck/mocha/commit/4c558fb83ca5d7e260961b1ebfddcd377017a608))
* **main:** release 11.0.2 ([#5269](https://github.com/Zenreck/mocha/issues/5269)) ([6caa902](https://github.com/Zenreck/mocha/commit/6caa9026eb120b136dc8210614b31310f8bff83b))
* **main:** release 11.1.0 ([#5277](https://github.com/Zenreck/mocha/issues/5277)) ([a87fb11](https://github.com/Zenreck/mocha/commit/a87fb1130a877649e564e144a73b1716b6296cbd))
* migrate ESLint config to flat config ([#5060](https://github.com/Zenreck/mocha/issues/5060)) ([8317f90](https://github.com/Zenreck/mocha/commit/8317f902a11a5837d00581e7926b145d20f59b61))
* more fully remove assetgraph-builder and canvas ([#5175](https://github.com/Zenreck/mocha/issues/5175)) ([1883c41](https://github.com/Zenreck/mocha/commit/1883c41a49fad009bd407efc1bece3a5c75fd10a))
* pin node-lts tests to 22.11.0 ([#5279](https://github.com/Zenreck/mocha/issues/5279)) ([664e1f4](https://github.com/Zenreck/mocha/commit/664e1f49f7ae214a9666c90f388407e9fa100309))
* remove `husky` for now ([#5127](https://github.com/Zenreck/mocha/issues/5127)) ([6dda9a4](https://github.com/Zenreck/mocha/commit/6dda9a476b54a9c00bacdb45aac74586ebeb42c2)), closes [#5124](https://github.com/Zenreck/mocha/issues/5124)
* remove deprecated Runner signature ([#4861](https://github.com/Zenreck/mocha/issues/4861)) ([b7b849b](https://github.com/Zenreck/mocha/commit/b7b849b76b19949303a2e105eea8ce4f9df49e02))
* remove failing hyperlink linkcheck task ([#5176](https://github.com/Zenreck/mocha/issues/5176)) ([24560c1](https://github.com/Zenreck/mocha/commit/24560c1532b8e67d1254b489fcc6f84c4033c0e1))
* remove nanoid as dependency ([#5024](https://github.com/Zenreck/mocha/issues/5024)) ([45e97af](https://github.com/Zenreck/mocha/commit/45e97af81f87c7ac71433b4558e58ad474ffeba8))
* remove stale workflow ([#5029](https://github.com/Zenreck/mocha/issues/5029)) ([b41e985](https://github.com/Zenreck/mocha/commit/b41e98533aa0fb87d7ba61163254881607a8a8c5))
* remove touch as dev dependency ([#5023](https://github.com/Zenreck/mocha/issues/5023)) ([48002bc](https://github.com/Zenreck/mocha/commit/48002bc60144c25060bf91359620c4a0284e8284))
* remove trailing whitespace in SECURITY.md ([7563e59](https://github.com/Zenreck/mocha/commit/7563e59ae3c78ada305d26eadb86998ab54342da))
* remove unnecessary canvas dependency ([#5069](https://github.com/Zenreck/mocha/issues/5069)) ([53a4baf](https://github.com/Zenreck/mocha/commit/53a4bafbdeb32576440b0a21787f2525585411c0))
* remove uuid dev dependency ([#5022](https://github.com/Zenreck/mocha/issues/5022)) ([ee2b70e](https://github.com/Zenreck/mocha/commit/ee2b70e8e82b0b67347d41028fa45521d43633d9))
* rename 'bin/mocha' to 'bin/mocha.js' ([#4863](https://github.com/Zenreck/mocha/issues/4863)) ([592905b](https://github.com/Zenreck/mocha/commit/592905b204fb3b6ef366f839994595e236a27e06))
* rename 'master' to 'main' in docs and tooling ([#5130](https://github.com/Zenreck/mocha/issues/5130)) ([b6aa7e8](https://github.com/Zenreck/mocha/commit/b6aa7e85b821a7859bb6e372d8c3efe67936d7c3))
* replace `fs-extra` with newer `fs` built-ins ([#5284](https://github.com/Zenreck/mocha/issues/5284)) ([75dcf8c](https://github.com/Zenreck/mocha/commit/75dcf8c6c40ed1ce134ae5e174b6f4c4ca4d8c42))
* replace `nps` with npm scripts ([#5128](https://github.com/Zenreck/mocha/issues/5128)) ([c44653a](https://github.com/Zenreck/mocha/commit/c44653a3a04b8418ec24a942fa7513a4673f3667)), closes [#5126](https://github.com/Zenreck/mocha/issues/5126)
* replace deprecated 'String.prototype.substr()' ([#4852](https://github.com/Zenreck/mocha/issues/4852)) ([a816130](https://github.com/Zenreck/mocha/commit/a81613070cebd545043cdeab97e9000ecaaae1a7))
* revert [#5069](https://github.com/Zenreck/mocha/issues/5069) to restore Netlify builds ([#5095](https://github.com/Zenreck/mocha/issues/5095)) ([3345eff](https://github.com/Zenreck/mocha/commit/3345eff154d40802ba4470b73fd0040c15f6c4f9))
* run Netlify deploy on Node v16 ([#4778](https://github.com/Zenreck/mocha/issues/4778)) [ci skip] ([9fbf3ae](https://github.com/Zenreck/mocha/commit/9fbf3aeb2e6c8c07ced79122f79a1ce73191d0f4))
* **site:** fix supporters' download ([#4859](https://github.com/Zenreck/mocha/issues/4859)) ([0608fa3](https://github.com/Zenreck/mocha/commit/0608fa3cab27d8ceaf18976d6fb128b9550fb989))
* switch 'linkify-changelog.js' to ESM ([#4812](https://github.com/Zenreck/mocha/issues/4812)) [ci skip] ([f297790](https://github.com/Zenreck/mocha/commit/f297790fb7d9035c001e5aca82b8487924354cdf))
* switch two-column list styles to be opt-in ([#5110](https://github.com/Zenreck/mocha/issues/5110)) ([e030115](https://github.com/Zenreck/mocha/commit/e0301154101989a26877fbb8a1e9c869c9f3e4a6))
* **test:** drop AMD/'requirejs' ([#4857](https://github.com/Zenreck/mocha/issues/4857)) ([785aeb1](https://github.com/Zenreck/mocha/commit/785aeb1ff22793086543c559f93e5b482621e820))
* update dependencies ([#4818](https://github.com/Zenreck/mocha/issues/4818)) ([1825645](https://github.com/Zenreck/mocha/commit/18256456822e46fa6d9952a15f264833371874ca))
* update dependencies ([#4843](https://github.com/Zenreck/mocha/issues/4843)) ([632e602](https://github.com/Zenreck/mocha/commit/632e6023584bcc877685de4fb5c5128e370b2b6a))
* update dependencies ([#4878](https://github.com/Zenreck/mocha/issues/4878)) ([fbe7a24](https://github.com/Zenreck/mocha/commit/fbe7a24269631b6f7c5d259cc8ce26b83b2e60dc))
* update some devDependencies ([#4733](https://github.com/Zenreck/mocha/issues/4733)) ([e975675](https://github.com/Zenreck/mocha/commit/e97567585726ca407be50baa5551ad8c5df07749))
* update some devDependencies ([#4775](https://github.com/Zenreck/mocha/issues/4775)) ([9c9fcb5](https://github.com/Zenreck/mocha/commit/9c9fcb5fd769ea5bf8ec6bc513478fa777055d5a))
* update some devDependencies ([#4816](https://github.com/Zenreck/mocha/issues/4816)) ([bc0fda2](https://github.com/Zenreck/mocha/commit/bc0fda2845f650ef1926a3be6fccefd72c2c8c88))
* use standard 'Promise.allSettled' instead of polyfill ([#4905](https://github.com/Zenreck/mocha/issues/4905)) ([77c18d2](https://github.com/Zenreck/mocha/commit/77c18d29c565e68a0d487e357765acb5ec776cc6))
* utils.type() ([#4457](https://github.com/Zenreck/mocha/issues/4457)); closes [#4306](https://github.com/Zenreck/mocha/issues/4306) ([1aa182b](https://github.com/Zenreck/mocha/commit/1aa182b95c58b0936e94364f7baf56636690b503))


### 🤖 Automation

* **deps:** bump the github-actions group with 1 update ([#5132](https://github.com/Zenreck/mocha/issues/5132)) ([e536ab2](https://github.com/Zenreck/mocha/commit/e536ab25b308774e3103006c044cb996a2e17c87))
* **deps:** bump the github-actions group with 2 updates ([#5125](https://github.com/Zenreck/mocha/issues/5125)) ([7ac67f3](https://github.com/Zenreck/mocha/commit/7ac67f3735b1ba6b1e1565ab9136d83c50f58abf))
* **v10.0.0:** release ([023f548](https://github.com/Zenreck/mocha/commit/023f548213e571031b41cabbcb8bb20e458b2725))
* **v10.0.0:** update CHANGELOG ([62b1566](https://github.com/Zenreck/mocha/commit/62b1566211a631b22f4bd7d888cd2c046efdd9e4))
* **v10.1.0:** release ([5f96d51](https://github.com/Zenreck/mocha/commit/5f96d511dbf913f135b92198aab721a27f6b44fe))
* **v10.1.0:** update CHANGELOG ([ed74f16](https://github.com/Zenreck/mocha/commit/ed74f16878f6520411d9a391c5f184056be6da30))
* **v10.2.0:** release ([202e9b8](https://github.com/Zenreck/mocha/commit/202e9b8b4d1b6611c96d95d631c49d631d88c827))
* **v10.2.0:** update CHANGELOG ([6782d6d](https://github.com/Zenreck/mocha/commit/6782d6d0757a5e7b49b291bcae173316ec00c513))
* **v9.1.0:** release ([014e47a](https://github.com/Zenreck/mocha/commit/014e47a8b07809e73b1598c7abeafe7a3b57a8f7))
* **v9.1.0:** update CHANGELOG [ci skip] ([3a14b28](https://github.com/Zenreck/mocha/commit/3a14b28bdfd785828ec862fe9fa8d19a651fd63c))
* **v9.1.1:** release ([654b5df](https://github.com/Zenreck/mocha/commit/654b5df4391172e69fe226dc36ebd1c89b20be53))
* **v9.1.1:** update CHANGELOG [ci skip] ([a26cca9](https://github.com/Zenreck/mocha/commit/a26cca9254f41ed5a049990da8093a9c4151e0fd))
* **v9.1.2:** release ([18a1055](https://github.com/Zenreck/mocha/commit/18a1055396744e3284b113bb114f52298f5e35ab))
* **v9.1.2:** update CHANGELOG [ci skip] ([06f3f63](https://github.com/Zenreck/mocha/commit/06f3f636c9056e88d79c64f50d0d0c14f5d7ac6c))
* **v9.1.3:** release ([28b4824](https://github.com/Zenreck/mocha/commit/28b482472a519b7abaf30a18b8ad709707bfd5a7))
* **v9.1.3:** update CHANGELOG [ci skip] ([3dcc2d9](https://github.com/Zenreck/mocha/commit/3dcc2d9563c7a74edad2a68bcee2a3990140ac70))
* **v9.1.4:** release ([0a1b7f8](https://github.com/Zenreck/mocha/commit/0a1b7f8a1505738449e8b0275d91664b5bae3d95))
* **v9.1.4:** update CHANGELOG [ci skip] ([a04d050](https://github.com/Zenreck/mocha/commit/a04d050b42819602e5c952a31a8162470a39db35))
* **v9.2.0:** release ([cc51b8f](https://github.com/Zenreck/mocha/commit/cc51b8fb42c4919e1304724bdb1a90699d17cf85))
* **v9.2.0:** update CHANGELOG [ci skip] ([dea3115](https://github.com/Zenreck/mocha/commit/dea3115123116f5d9adcd0fe5f2ae0a86dda03a1))
* **v9.2.1:** release ([547ffd7](https://github.com/Zenreck/mocha/commit/547ffd73535088322579d3d2026432112eae3d4b))
* **v9.2.1:** update CHANGELOG [ci skip] ([ca7432a](https://github.com/Zenreck/mocha/commit/ca7432a86541d1b3f8285403d11c8aa3acad2166))
* **v9.2.2:** release ([24b5243](https://github.com/Zenreck/mocha/commit/24b5243514fee35bb78cf81d7fa541112a566a22))
* **v9.2.2:** update CHANGELOG [ci skip] ([22a1560](https://github.com/Zenreck/mocha/commit/22a156064ccfffca8595171cdf0d8401272a7912))
